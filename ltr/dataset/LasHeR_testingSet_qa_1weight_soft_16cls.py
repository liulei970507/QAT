...
class LasHeR_testingSet_qa_1weight_soft_16cls(BaseVideoDataset):
    def __init__(self, root=None, image_loader=jpeg4py_loader, data_fraction=None):
        ...
        super().__init__('LasHeR_testingSet_qa_1weight_soft_16cls', root, image_loader)
    ...
    def get_name(self):
        return 'LasHeR_testingSet_qa_1weight_soft_16cls'
    ...
    def _get_qa_label(self, seq_name, frame_id):
        rgb_t_label_file  = np.loadtxt(os.path.join('/data/liulei/pytracking/pytracking/tracking_results/dimp/dimp50_rgbt_three_branches_20211120/lasher', seq_name+'_iou.txt'))[frame_id]   
        # 得分阈值
