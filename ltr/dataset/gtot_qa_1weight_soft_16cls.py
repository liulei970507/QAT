...
class GTOT_qa_1weight_soft_16cls(BaseVideoDataset):
    def __init__(self, root=None, image_loader=jpeg4py_loader, data_fraction=None):
        ...
        super().__init__('GTOT_qa_1weight_soft_16cls', root, image_loader)
    ...
    def get_name(self):
        return 'gtot_qa_1weight_soft_16cls'
    ...
    def _get_qa_label(self, seq_name, frame_id):
        # 质量差异得分参考
        #  ref = [ i/16 for i in range(16) ]
        # 获取当前帧质量得分
        rgb_t_label_file  = np.loadtxt(os.path.join('/data/liulei/pytracking/pytracking/tracking_results/dimp/dimp50_rgbt_three_branches_20211120/gtot', seq_name+'_iou.txt'))[frame_id]   
        # 得分阈值
