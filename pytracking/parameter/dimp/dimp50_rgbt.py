...
def parameters():
    ...
    # params.net = NetWithBackbone(net_path= '/data/liulei/pytracking/ltr/checkpoints/ltr/dimp/dimp50_rgbt/DiMPnet_RGBT_ep0050.pth.tar',use_gpu=params.use_gpu)

    # params.net = NetWithBackbone(net_path= '/data/liulei/pytracking/ltr/checkpoints/ltr/dimp/dimp50_rgbt_film_1weight_bn/DiMPnet_RGBT_ep0050.pth.tar',use_gpu=params.use_gpu)

    # params.net = NetWithBackbone(net_path= '/data/liulei/pytracking/ltr/checkpoints/ltr/dimp/dimp50_rgbt_film_2weight_bn_qa_v2/DiMPnet_RGBT_ep0050.pth.tar',use_gpu=params.use_gpu)
    net_path = '/home/liulei/RGBT/pytracking/ltr/checkpoints/ltr/dimp/dimp50_rgbt_film_1weight_soft_16cls_v1_db50/DiMPnet_RGBT_ep0050.pth.tar'
    print('net_path:', net_path)
    params.net = NetWithBackbone(net_path = net_path,use_gpu = params.use_gpu)
