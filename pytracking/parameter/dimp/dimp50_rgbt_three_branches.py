...
def parameters():
    ...
    params.net_v = NetWithBackbone(net_path='/data/liulei/pytracking/pytracking/networks/dimp50.pth',use_gpu=params.use_gpu)
    params.net_i = NetWithBackbone(net_path='/data/liulei/pytracking/pytracking/networks/dimp50.pth',use_gpu=params.use_gpu)
